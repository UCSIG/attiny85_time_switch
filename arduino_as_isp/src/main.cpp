...
#if SLOW_PROGRAMMING == 1

// For normal clock.
#define SPI_CLOCK (1000000 / 6)
#else

// For slow clock (128kHz).
#define SPI_CLOCK (25000 / 6)
#endif
...
#define SPI_MODE0 0x00
    ...
    ARDUINO_API_VERSION != 10001 // A SPISettings class is declared by ArduinoCore-API 1.0.1
class SPISettings {
public:
    // clock is in Hz
